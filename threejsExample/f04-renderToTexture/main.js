...
function init() {
  ...
  scene2Cam = new THREE.OrthographicCamera(
    window.innerWidth / -2, window.innerWidth / 2,
    window.innerHeight / 2, window.innerHeight / -2,
    -10000, 10000);
  scene2Cam.position.z = 1;
  scene2.add(scene2Cam);
...
function initMesh() {
  ...
  // let positionAttribute = new THREE.Float32BufferAttribute(cube.positions, 3);
  // let uvAttribute = new THREE.Float32BufferAttribute(cube.uv2, 2);
  ...
  //   texture.needsUpdate = true;
  // }
  //  texture = renderTarget.texture.clone();
...
function animate() {
  ...
  drawF();
  let point = new THREE.Vector3(1, 1, 1);
...
function render() {
  renderer.render(scene, camera, firstRenderTarget);
  renderer.render(scene2, scene2Cam, renderTarget);
